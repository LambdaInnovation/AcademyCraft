...
public class EnergyUIHelper {
	...
	public static final Color 
		CRL_GLOW = new Color().setColor4i(0, 214, 232, 220),
		CRL_BACK = new Color().setColor4i(0, 128, 165, 120);
	
	public static void drawBox(double x, double y, double width, double height) {
		CRL_BACK.bind();
		HudUtils.colorRect(x, y, width, height);
		
		ACRenderingHelper.drawGlow(x, y, width, height, 5, CRL_GLOW);
	}
