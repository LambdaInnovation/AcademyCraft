 ...
 *
 */
public class RenderDeveloper extends RenderBlockMultiModel {
	
	private static Random RNG = new Random();
	public RenderDeveloper() {
		super(new TileEntityModelCustom(ACModels.MDL_ABILITY_DEVELOPER), ACClientProps.TEX_MDL_DEVELOPER);
		setScale(0.021F);
	}
